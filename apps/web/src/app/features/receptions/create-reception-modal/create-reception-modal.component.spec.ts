...
import { CreateReceptionModalComponent } from './create-reception-modal.component';
...
describe('CreateReceptionModalComponent', () => {
  let fixture: ComponentFixture<CreateReceptionModalComponent>;
  let component: CreateReceptionModalComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CreateReceptionModalComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(CreateReceptionModalComponent);
  ...
  it('does not submit without a destination location', () => {
  ...
  it('emits reception data when the form is valid', () => {
    const emit = vi.spyOn(component.submitForm, 'emit');
    component.selectedWarehouseId = 'warehouse-1';

...
// Shared with the web-e2e Playwright webServer (apps/web-e2e/src/support/
// start-api.cjs); the helpers live in tools/ as CommonJS so the raw-node
// webServer can require them without a TypeScript build.
// eslint-disable-next-line @nx/enforce-module-boundaries
import {
  ensureDatabaseExists,
  truncateAllTables,
} from '../../../../tools/e2e/db-prep';
